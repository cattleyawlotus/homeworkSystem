<template>
  <div class="blogs">
    <div class="content-header">
      <h1>{{this.nickname}}<small>发布博客</small></h1>
          ...
          <div class="required field">
            <div class="ui left labeled input">
              <el-form-item prop="shareStatement">
                <el-select v-model="formData.shareStatement" placeholder="版权" style="margin-right: 10px; width: 100px;margin-left: 155px">
                  <el-option
          ...
          <div class="two fields" style="margin-top: 3px">
            <el-form-item prop="typeId">
              <el-row>
                ...
                <el-select v-model="formData.tags" value-key="id" multiple placeholder="请选择标签" style="width: 470px">
                  <el-option
  ...
  data () {
    return {
      ...
      formData: {
        ...
        commentabled: false, // 是否开启评论
        published: false, // 发布状态 (草稿还是发布)
        tags: [] // 标签列表,
      }, // 表单数据
      toolbars: {
        bold: true, // 粗体
