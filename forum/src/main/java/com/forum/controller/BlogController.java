...
public class BlogController {
    ...
    public CommonResult getAllBlog(@Validated @ApiParam("分页参数") PageReq req){
        PageUtil<Blog>page = new PageUtil<>(blogService.getAllBlog(req.getCurrPage(),req.getPageSize()));
