        ...
        <div style="width:1000px;">
          ...
          <div class="ui top attached segment my-shadow">
            <div class="ui middle aligned two column grid">
              <div class="column">
                <h3 class="ui my-blue header">从网络爬取的法律文书</h3>
              </div>
      ...
      <div id="toolbar" class="m-padded m-fixed m-right-bottom" >
        <div class="ui vertical icon buttons ">
          <el-popover
            ...
            trigger="hover"
            content="暂未导入案例！">
            <el-button slot="reference" type="button" class="ui toc blue button" @click="handleCreate">提示</el-button>
          </el-popover>
...
<style scoped>
  ...
  .types-banner {
    ...
    background: url('../../assets/images/crabanner.png') center
    center / cover no-repeat;
