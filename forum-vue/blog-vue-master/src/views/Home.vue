    ...
    <div class="home-banner">
      <div class="banner-container">
        ...
        <div class="blog-contact animated zoomIn">
          <a class="github circular icon button" data-content="https://github.com" data-position="bottom center" style="margin-right: 50px"><i class="github icon"></i></a>
          <a class="wechat circular icon button" style="margin-right: 50px"><i class="weixin icon"></i></a>
          <a class="qq circular icon button" data-content="294193284" data-position="bottom center"><i class="qq icon"></i></a>
        </div>
        <div class="ui wechat-qr flowing popup transition hidden">
          <img src="https://img0.baidu.com/it/u=3791200980,1036264604&fm=26&fmt=auto" alt="" class="ui rounded image" style="width: 110px">
        </div>
        <!-- 向下滚动 -->
    ...
    <div  class="m-home">
      <div class="ui container">
        <div class="ui stackable grid" style="width: 1500px">
          ...
          <div class="eleven wide column">
            ...
            <div class="ui top attached segment">
              <div class="ui middle aligned two column grid my-shadow">
                <div class="column">
                  <h3 class="ui my-blue header" >论坛</h3>
                </div>
                  ...
                  <div class="eleven wide column" style="cursor:pointer;">
                    ...
                    <div class="ui grid">
                      ...
                      <div class="right aligned five wide column">
                        <a target="_blank" class="ui my-blue basic label m-padded-tiny m-text-thin">{{item.type}}</a>
                      </div>
                    </div>
                  </div>
                  <div class="five wide column" align="right">
                    <a target="_blank">
                      <img v-bind:src="item.firstPicture" @click="toBlog(item.id)" alt="" class="ui rounded image" style="height: 200px">
                    </a>
                  </div>
          ...
          <!--右边的top-->
          <div class="four wide column" style="left: 34px !important;">
...
export default {
  ...
  methods: {
    ...
    async findPage () {
      ...
      // }
      // var param = this.$encrypTion(JSON.stringify(PageReq))
...
<style>
  ...
  .home-banner {
    ...
    right: 0;
    height: 100vh;
    /* background: url("https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fb-ssl.duitang.com%2Fuploads%2Fitem%2F201807%2F18%2F20180718225305_sayqp.jpg&refer=http%3A%2F%2Fb-ssl.duitang.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1637482616&t=8ab32d5a85836ec44d51996986b45cfd") center center /
    cover no-repeat; */
     background: url("../assets/images/home.png") center center /
    cover no-repeat;
