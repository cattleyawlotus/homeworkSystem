...
export default {
  ...
  methods: {
    ...
    async getArchiveList () {
      const { data: res } = await this.$http.get('/api/forum/collects/getcollectedblog?currPage=' + this.pagination.currPage + '&pageSize=' + this.pagination.pageSize + '&uid=' + this.uid)
      console.log(res)
      if (!res.success) {
