      ...
      <div class="left">
        ...
        <div class="menu">
          <ul class="menu-ul">
            ...
            <router-link class="menu-link" :to="{ path: '/live-record'}" tag="li">消息通知</router-link>
          </ul>
        </div>
      </div>
      <div class="content">
...
.content{vertical-align: top; display: inline-block;width: 1090px;  height: 735px;margin-left: 20px; overflow-y: auto;overflow: hidden;}
